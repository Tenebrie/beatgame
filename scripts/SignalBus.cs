...
public partial class SignalBus : Node
{
	...
	[Signal]
	public delegate void ObjectTargetedEventHandler(BaseUnit unit, TargetedUnitAlliance alliance);
	[Signal]
	public delegate void ObjectUntargetedEventHandler(TargetedUnitAlliance alliance);
	[Signal]
